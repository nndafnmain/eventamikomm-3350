...
<header class="flex justify-between items-center mb-10">
    <div>
        ...
        <p class="text-slate-500 font-medium">
            Atur kategori event untuk platform Anda.
        </p>
    </div>
</header>
    ...
    <div class="p-8 border-b border-slate-100 flex flex-col lg:flex-row gap-4 justify-between">
        ...
        >
            ...
            <input 
                ...
                class="px-5 py-3 rounded-2xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            >
                    ...
                    <td class="px-8 py-6 flex gap-2">
                        ...
                        >
                            ...
                            <input 
                                ...
                                name="name"
                                value="{{ $category->name }}"
                                class="px-4 py-2 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                            >
