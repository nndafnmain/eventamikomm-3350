    ...
    <div class="lg:col-span-1">
        <div class="sticky top-32">
            ...
            <div class="mt-8 p-6 bg-white rounded-3xl border border-slate-100 shadow-sm">
                <h4 class="font-bold mb-4">Informasi Event</h4>
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <p class="font-semibold">
                            {{ $event->date->translatedFormat('H:i') }} WIB
                        </p>
                    </div>
        ...
        <div class="space-y-4">
            ...
            <div class="flex flex-wrap gap-6 text-slate-500 font-medium">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span>
                        {{ $event->date->translatedFormat('l, d F Y H:i') }}
                    </span>
                </div>
            ...
            <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
                ...
                <div>
                    ...
                    @else
                        <button
                            disabled
                            class="inline-block px-10 py-5 bg-slate-300 text-slate-500 rounded-2xl font-black text-xl cursor-not-allowed">
                            Tiket Habis
                        </button>
                    @endif
        ...
        <div class="space-y-4">
            ...
            <ul class="space-y-3 text-slate-500">
                ...
                <li class="flex items-start gap-2">
                    ...
                    Tiket dapat digunakan untuk check-in saat acara berlangsung.
                </li>
